...
import InputPhoto from '../../../components/inputs/input-photo';
...
const FormProfile = ({surname, name, patronymic, description, course, specialty, technologies, linkToGit, linkToBehance, linkToVK, profilePicture}: FormProfileProps) => {
