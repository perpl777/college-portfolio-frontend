...
const Post = ({title, markupWithBackground, publishedAt, work_type, photo}: DataPost) => {
    ...
    return (
        <div className='flex flex-row cursor-pointer'>
            ...
            ? (
                <>
                    <div className='p-11 flex flex-col w-1/2 justify-between gap-16 border-t border-x border-black max-[1040px]:gap-5 max-md:p-3 hover:bg-slate-200 transition-all'>
