        ...
        <div className='flex max-h-[566px] max-lg:inline-block max-lg:max-h-max'>
            ...
            <div className="bg-gray-50 flex flex-col flex-auto justify-between py-9 px-5">
                <div className='flex justify-end gap-2 max-lg:pb-3'>
                    {linkToVK && 
                        <Link href={linkToVK} target='_blank'><Image src={Vk} alt='vk' width={40} height={40}></Image> </Link>
                    }
                    {linkToGit && 
                        <Link href={linkToGit} target='_blank'><Image src={Github} alt='github' width={40} height={40}></Image></Link>
                    }
                    {linkToBehance && 
                        <Link href={linkToBehance} target='_blank'><Image src={Behance} alt='behance' width={40} height={40}></Image></Link>
                    }
                </div>
